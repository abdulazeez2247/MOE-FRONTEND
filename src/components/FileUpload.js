...
//                 className="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-10 py-4 rounded-xl text-lg font-semibold hover:from-primary-700 hover:to-primary-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105"
//               >
//                 Upgrade to Pro
//               </button>
//             </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-8 md:py-16">
        <div className="container">
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl border-2 border-dashed border-gray-300 p-6 md:p-12 text-center shadow-xl">
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br from-yellow-100 to-yellow-200 rounded-2xl md:rounded-3xl flex items-center justify-center mb-6 md:mb-8">
                <svg className="h-8 w-8 md:h-12 md:w-12 text-yellow-600" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                  <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4 text-balance">
                File Upload Requires Pro Plan
              </h3>
              <p className="text-base md:text-lg text-gray-600 mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed text-balance">
                Upgrade to Pro for advanced file parsing and diagnostics. Pro analyzes .cab, .cabx, .mzb, and .xml files with detailed step-by-step optimization recommendations.
              </p>
              <button
                onClick={onUpgradeClick}
            ...
            {[
              {
                ...
                title: "File Analysis",
                description: "Deep analysis of your millwork files to identify potential issues and optimization opportunities.",
              ...
              },
              {
                ...
                description: "Get recommendations for CNC path optimization and collision detection to improve efficiency.",
              ...
              },
              {
                ...
                description: "Receive detailed installation notes and assembly sequences for complex joinery sections.",
              ...
              <div key={index} className="card card-hover p-6 md:p-8">
                ...
                <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2 md:mb-3 text-balance">{feature.title}</h4>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed text-balance">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-8 md:py-16">
      <div className="container">
        ...
        <div className="space-y-6 md:space-y-8">
          {/* Upload Area */}
          <div
            className={`relative bg-white rounded-2xl md:rounded-3xl file-upload-area p-6 md:p-12 text-center shadow-xl border-2 border-dashed transition-all duration-200 ${
              dragActive ? 'drag-active border-primary-500 bg-primary-50' : 'border-gray-300 hover:border-primary-400 hover:bg-gray-50'
            }`}
            onDragEnter={handleDrag}
            onDragLeave={handleDrag}
          ...
          >
            ...
            <div className="w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl md:rounded-3xl flex items-center justify-center mx-auto mb-6 md:mb-8">
              <svg className="h-8 w-8 md:h-12 md:w-12 text-primary-600" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            ...
            <div className="mt-4">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 md:mb-4 text-balance">
                Upload Millwork Files
              </h3>
              <p className="text-base md:text-lg text-gray-600 mb-3 md:mb-4 text-balance">
                Drag and drop your .cab, .cabx, .mzb, or .xml files here, or click to browse
              </p>
              <p className="text-sm text-gray-500">
                Supported formats: .cab, .cabx, .mzb, .xml
          ...
          {isUploading && (
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6 md:p-8">
              <div className="flex items-center justify-center">
                <div className="animate-spin rounded-full h-6 w-6 md:h-8 md:w-8 border-b-2 border-blue-600 mr-3 md:mr-4"></div>
                <div>
                  <h4 className="text-base md:text-lg font-semibold text-blue-900">Analyzing Files</h4>
                  <p className="text-blue-800 text-sm md:text-base">Processing your millwork files for optimization recommendations...</p>
                </div>
              </div>
            </div>
          )}
          ...
          {uploadedFiles.length > 0 && (
            <div className="space-y-4 md:space-y-6">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 text-center">Analyzed Files</h3>
              <div className="grid grid-cols-1 gap-4 md:gap-6">
                {uploadedFiles.map((file) => (
                  <div key={file.id} className="card card-hover p-4 md:p-8">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between space-y-4 md:space-y-0">
                      <div className="flex-1">
                        <div className="flex items-start mb-3 md:mb-4">
                          <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-xl md:rounded-2xl flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
                            <svg className="h-5 w-5 md:h-6 md:w-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                            </svg>
                          </div>
                          <div className="flex-1 min-w-0">
                            <h4 className="text-lg md:text-xl font-bold text-gray-900 truncate">{file.name}</h4>
                            <p className="text-sm text-gray-500">
                              {(file.size / 1024).toFixed(1)} KB • {file.type}
                            </p>
                          </div>
                        </div>
                        <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 md:p-6">
                          <h5 className="font-semibold text-gray-900 mb-2">Analysis Results</h5>
                          <p className="text-gray-700 leading-relaxed text-sm md:text-base">{file.analysis}</p>
                        </div>
                      </div>
                      <button
                        onClick={() => removeFile(file.id)}
                        className="text-gray-400 hover:text-red-500 transition-colors duration-200 p-2 self-start md:self-center"
