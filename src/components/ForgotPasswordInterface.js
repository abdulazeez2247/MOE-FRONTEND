          ...
          <div className="card p-6 md:p-12">
            <div className="text-center">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 md:p-4 mb-4 md:mb-6">
                <p className="text-sm text-blue-800 text-balance">
                  <strong>Didn't receive the email?</strong> Check your spam folder or try again with a different email address.
                </p>
              </div>
              ...
              <button
                ...
                className="w-full btn btn-secondary mb-3 md:mb-4"
              >
                Try Another Email
              </button>
        ...
        <div className="card p-6 md:p-12">
          <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
            <div className="form-group">
              <label className="form-label text-lg md:text-xl">
                Email Address
              </label>
              <input
                type="email"
                ...
                onChange={handleEmailChange}
                placeholder="Enter your email address"
                className={`form-input text-base md:text-lg py-3 md:py-4 ${error ? 'form-input-error' : ''}`}
                required
              />
              {error && (
                <p className="form-error text-sm md:text-base">{error}</p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full btn btn-primary py-3 md:py-4 text-base md:text-lg font-bold"
            >
              {isLoading ? (
                <div className="flex items-center justify-center">
          ...
          <button
            onClick={onSwitchToLogin}
            className="w-full btn btn-secondary py-3 md:py-4 text-base md:text-lg font-semibold"
          >
            Back to Sign In
          </button>
        </div>

        <div className="mt-8 md:mt-10 bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-xl md:rounded-2xl p-4 md:p-8">
          <div className="flex items-start">
            <div className="w-10 h-10 md:w-12 md:h-12 bg-orange-100 rounded-xl md:rounded-2xl flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
              <svg className="w-5 h-5 md:w-6 md:h-6 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
            </div>
            <div>
              <p className="font-semibold text-orange-900 mb-1 text-sm md:text-base">Need Help?</p>
              <p className="text-orange-800 text-xs md:text-sm">If you're still having trouble, contact our support team and we'll help you regain access to your account.</p>
            </div>
          </div>
        </div>
      </div>
